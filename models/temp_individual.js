...
const schema = new mongoose.Schema({
    salutation: { type: mongoose.Schema.Types.ObjectId, ref: "codedomain_values" },
    password: String,
    firstname: String,
    middlename: String,
    lastname: String,
    ...
    email_address: { type: mongoose.Schema.Types.ObjectId, ref: "email_address" },
}, { timestamps: true })
module.exports = mongoose.model('temp_individual', schema)